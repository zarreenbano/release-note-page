...
function LoginPage() {
    ...
    const handleSubmit = (e)=>{
        ...
        setError("");
        if (isSignup) {
            const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signup"])(email, password);
            if (success) {
            ...
            const success = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["login"])(email, password);
            if (success) {
                window.location.href = "/card";
            } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a5949f4b._.js.map